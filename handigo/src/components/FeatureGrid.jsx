...
const FeatureGrid = () => {
  return (
    <section id="fitur" className="scroll-mt-24 mb-16 md:mb-20">
      <Container>
        <h2 className="text-3xl font-bold text-primary-blue text-center mb-8 md:mb-10">
          Fitur Utama
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((item, index) => (
            <div
              key={index}
              className="bg-light-blue p-6 md:p-8 rounded-3xl hover:shadow-md transition"
            >
              {/* ICON WRAPPER */}
